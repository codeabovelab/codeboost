...
Selection history: the first frozen draft paired #554 with #556. Before either implementation began, their required baseline check found that both depend on live 1,400-action/session telemetry unavailable from the operator's environment. They were replaced with #335 and #172, whose evidence can be reproduced locally. The replacement's A/B placement was randomized once; no timed review had started and no planted change existed.
