...
Shutdown first stops HTTP admission, then aborts and awaits an active merge CLI process before closing the review service. A cancelled command cannot outlive the local state that authorized it.
